...
@LinkURI("http://w3id.org/kgcl/RemoveFromSubset")
public class RemoveFromSubset extends SubsetMembershipChange {
    ...
    public boolean equals(final Object o) {
        ...
        if ( !(o instanceof RemoveFromSubset) ) return false;
        final RemoveFromSubset other = (RemoveFromSubset) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof RemoveFromSubset;
    }
