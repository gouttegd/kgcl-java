...
@LinkURI("http://w3id.org/kgcl/NodeDeletion")
public class NodeDeletion extends NodeChange {
    ...
    public String toString() {
        return "NodeDeletion(id=" + this.getId() + ")";
    }

    @Override
    public boolean equals(final Object o) {
        if ( o == this ) return true;
        if ( !(o instanceof NodeDeletion) ) return false;
        final NodeDeletion other = (NodeDeletion) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof NodeDeletion;
    }
