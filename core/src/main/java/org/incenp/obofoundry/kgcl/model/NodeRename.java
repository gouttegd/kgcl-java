...
@LinkURI("http://w3id.org/kgcl/NodeRename")
public class NodeRename extends NodeChange {
    ...
    public String toString() {
        return "NodeRename(id=" + this.getId() + ")";
    }

    @Override
    public boolean equals(final Object o) {
        if ( o == this ) return true;
        if ( !(o instanceof NodeRename) ) return false;
        final NodeRename other = (NodeRename) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof NodeRename;
    }
