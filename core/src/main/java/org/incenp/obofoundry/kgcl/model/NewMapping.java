...
@LinkURI("http://w3id.org/kgcl/NewMapping")
public class NewMapping extends NodeMappingChange {
    ...
    public String toString() {
        return "NewMapping(id=" + this.getId() + ")";
    }

    @Override
    public boolean equals(final Object o) {
        if ( o == this ) return true;
        if ( !(o instanceof NewMapping) ) return false;
        final NewMapping other = (NewMapping) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof NewMapping;
    }
