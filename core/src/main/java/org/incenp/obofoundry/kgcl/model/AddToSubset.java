...
@LinkURI("http://w3id.org/kgcl/AddToSubset")
public class AddToSubset extends SubsetMembershipChange {
    ...
    public boolean equals(final Object o) {
        ...
        if ( !(o instanceof AddToSubset) ) return false;
        final AddToSubset other = (AddToSubset) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof AddToSubset;
    }
