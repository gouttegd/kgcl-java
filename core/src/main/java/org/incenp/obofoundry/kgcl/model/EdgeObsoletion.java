...
@LinkURI("http://w3id.org/kgcl/EdgeObsoletion")
public class EdgeObsoletion extends EdgeChange {
    ...
    public String toString() {
        return "EdgeObsoletion(id=" + this.getId() + ")";
    }

    @Override
    public boolean equals(final Object o) {
        if ( o == this ) return true;
        if ( !(o instanceof EdgeObsoletion) ) return false;
        final EdgeObsoletion other = (EdgeObsoletion) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof EdgeObsoletion;
    }
