...
@LinkURI("http://w3id.org/kgcl/EdgeDeletion")
public class EdgeDeletion extends EdgeChange {
    ...
    public String toString() {
        return "EdgeDeletion(id=" + this.getId() + ")";
    }

    @Override
    public boolean equals(final Object o) {
        if ( o == this ) return true;
        if ( !(o instanceof EdgeDeletion) ) return false;
        final EdgeDeletion other = (EdgeDeletion) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof EdgeDeletion;
    }
