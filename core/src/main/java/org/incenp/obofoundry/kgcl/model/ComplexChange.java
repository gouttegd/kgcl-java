...
@LinkURI("http://w3id.org/kgcl/ComplexChange")
public abstract class ComplexChange extends Change {
    ...
    public String toString() {
        return "ComplexChange(id=" + this.getId() + ")";
    }

    @Override
    public boolean equals(final Object o) {
        if ( o == this ) return true;
        if ( !(o instanceof ComplexChange) ) return false;
        final ComplexChange other = (ComplexChange) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof ComplexChange;
    }
