...
@LinkURI("http://w3id.org/kgcl/NodeObsoletion")
public class NodeObsoletion extends NodeChange {
    ...
    @Override
    public NodeUnobsoletion getHasUndo() {
        return (NodeUnobsoletion) super.getHasUndo();
    }

    public void setHasUndo(NodeUnobsoletion value) {
        super.setHasUndo(value);
    }

    @Override
    public void setHasUndo(Change value) {
        if ( !(value instanceof NodeUnobsoletion) ) {
    ...
    public String toString() {
        return "NodeObsoletion(id=" + this.getId() + ")";
    }

    @Override
    public boolean equals(final Object o) {
        if ( o == this ) return true;
        if ( !(o instanceof NodeObsoletion) ) return false;
        final NodeObsoletion other = (NodeObsoletion) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof NodeObsoletion;
    }
