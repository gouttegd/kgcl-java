...
public class LanguageTagChange extends DatatypeOrLanguageTagChange {
    ...
    public boolean equals(final Object o) {
        ...
        if ( !(o instanceof LanguageTagChange) ) return false;
        final LanguageTagChange other = (LanguageTagChange) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof LanguageTagChange;
    }
