...
@LinkURI("http://w3id.org/kgcl/RemoveMapping")
public class RemoveMapping extends NodeMappingChange {
    ...
    public String toString() {
        return "RemoveMapping(id=" + this.getId() + ")";
    }

    @Override
    public boolean equals(final Object o) {
        if ( o == this ) return true;
        if ( !(o instanceof RemoveMapping) ) return false;
        final RemoveMapping other = (RemoveMapping) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof RemoveMapping;
    }
