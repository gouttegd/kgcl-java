...
@LinkURI("http://w3id.org/kgcl/NewMetadataAssertion")
public class NewMetadataAssertion extends NodeMetadataAssertionChange {
    ...
    public String toString() {
        return "NewMetadataAssertion(id=" + this.getId() + ")";
    }

    @Override
    public boolean equals(final Object o) {
        if ( o == this ) return true;
        if ( !(o instanceof NewMetadataAssertion) ) return false;
        final NewMetadataAssertion other = (NewMetadataAssertion) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof NewMetadataAssertion;
    }
