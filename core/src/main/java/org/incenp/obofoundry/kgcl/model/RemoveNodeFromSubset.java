...
@LinkURI("http://w3id.org/kgcl/RemoveNodeFromSubset")
public class RemoveNodeFromSubset extends NodeChange {
    ...
    public String toString() {
        return "RemoveNodeFromSubset(id=" + this.getId() + ")";
    }

    @Override
    public boolean equals(final Object o) {
        if ( o == this ) return true;
        if ( !(o instanceof RemoveNodeFromSubset) ) return false;
        final RemoveNodeFromSubset other = (RemoveNodeFromSubset) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof RemoveNodeFromSubset;
    }
